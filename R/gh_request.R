...
default_send_headers <- c("User-Agent" = "https://github.com/coatless/rest")

rest_build_request <- function(endpoint = "/user", params = list(),
  ...
  working <- rest_set_verb(working)
  working <- rest_set_endpoint(working)
  working <- rest_set_query(working)
  working <- rest_set_body(working)
  working <- rest_set_url(working)
  working <- rest_set_headers(working)
  working <- rest_set_dest(working)
...
rest_send_headers <- function(accept_header = NULL, headers = NULL) {
  modify_vector(
